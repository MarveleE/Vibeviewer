...
struct CursorUsageAPI: DecodableTargetType {
  ...
  var task: Task {
    .requestParameters(parameters: ["user": workosUserId], encoding: URLEncoding.queryString)
  }
  var headers: [String: String]? { APIHeadersBuilder.basicHeaders(cookieHeader: cookieHeader) }
  var sampleData: Data {
    Data(
